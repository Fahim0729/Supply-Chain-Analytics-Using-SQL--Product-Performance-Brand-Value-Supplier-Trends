...
<p style="color:blue;">SQL Functions & Features Used: SUM(), AVG(), JOIN(), WHERE(), BETWEEN(), GROUP BY(), HAVING(), CTEs, RANK(), ROW_NUMBER(), LAG(), ORDER BY(), CASE, Subquery, ROUND(), and filtering logic</p>
